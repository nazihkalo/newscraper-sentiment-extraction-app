...
class FinBert(object):
    ...
    def prepare_model(self, label_list):
        ...
        self.tokenizer = BertTokenizer.from_pretrained('finbert-sentiment/bert-base-uncased-vocab.txt', do_lower_case=self.config.do_lower_case)
...
def predict(text, model, write_to_csv=False, path=None):
    ...
    """
    model.eval()
    tokenizer = BertTokenizer.from_pretrained('finbert-sentiment/bert-base-uncased-vocab.txt')
